...
int main()
{
	...
	radacina = NULL;
		...
		radacina = insereaza(radacina, 7, NULL);
		radacina = insereaza(radacina, 1, NULL);
		radacina = insereaza(radacina, 3, NULL);
		radacina = insereaza(radacina, 5, NULL);
		radacina = insereaza(radacina, 6, NULL);
		radacina = insereaza(radacina, 8, NULL);
		radacina = insereaza(radacina, 9, NULL);
